...
class Soghan_model extends CI_Model {
    ...
    {
        $this->db->select('vendor_detail_id, english_contact_name, english_company_name, phone, mobile, email, english_description, latitude, longitude, english_city, english_area, english_country, image, english_vendor_type');
