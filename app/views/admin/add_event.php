    ...
    <div class="login-form">
        ...
        <div id="isbn_data"></div>
            ...
            <div class="input-wrap">
                ...
                <input type="text" id="arabic_event_name" name="arabic_event_name" value="<?php echo $event->arabic_name; ?>" class="form-control">
            </div>
            ...
            <div class="input-wrap">
                ...
                <input type="text" id="arabic_title" name="arabic_title" value="<?php echo $event->arabic_title; ?>" class="form-control" required="required">
            </div>
            ...
            <div class="input-wrap">
                <label for="title">Location (english)</label>
                <input type="text" id="location" name="location" value="<?php echo $event->event_location; ?>" class="form-control" required="required">
            </div>
            
            <div class="input-wrap">
                <label for="title">Location (arabic)</label>
                <input type="text" id="arabic_location" name="arabic_location" value="<?php echo $event->arabic_event_location; ?>" class="form-control" required="required">
            </div>
            ...
            <div class="input-wrap">
                <label for="title">Note (English)</label>
                <textarea cols="5" rows="5" id="note" name="note" class="form-control"><?php echo $event->notes; ?></textarea>
            </div>

            <div class="input-wrap">
                <label for="title">Note (Arabic)</label>
                <textarea cols="5" rows="5" id="note" name="arabic_note" class="form-control"><?php echo $event->arabic_notes; ?></textarea>
            </div>
