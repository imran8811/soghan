    ...
    <div class="login-form">
        ...
        <div id="isbn_data"></div>
            ...
            <div class="input-wrap">
                <label for="title">Vendor Title (arabic)</label>
                <input type="text" id="type" name="type" value="<?php echo $vendor->vendor_type; ?>" class="form-control">
            </div>
            
            <div class="input-wrap">
                <label for="title">Vendor Title (english)</label>
                <input type="text" id="english_type" name="english_type" value="<?php echo $vendor->english_vendor_type; ?>" class="form-control">
            </div>
